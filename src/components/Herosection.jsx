  ...
  return (
   <div className='h-auto md:h-[40rem] w-full  rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0 text-white'>
    <div className='p-4 relative z-10 w-full text-center'>
        ...
        <p className='mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati minus ullam eos nihil earum? Consequuntur nisi quidem eius, quibusdam doloremque provident saepe fugiat quaerat expedita mollitia facilis eligendi dolorum commodi.</p>
    </div>
    <div className='mt-4'>
       <Link href={"/Our Courses"}> <Button className="1.75 rem bg-white dark:bg-black text-black dark:text-white border-neutral-200 dark:border-slate-800">Explore Courses</Button></Link>
    </div>
